...
- (void)drawNeedleOnLayer:(CALayer*)layer inRect:(CGRect)rect
{
    ...
    leftNeedleLayer.fillColor = CGRGB(255, 255, 255);
    ...
    rightNeedleLayer.fillColor = CGRGB(255, 255, 255);
    ...
    screwLayer.fillColor = CGRGB(255, 255, 255);
    screwLayer.strokeColor = CGRGBA(255, 255, 255, 100);
